...
function Initialization(InitialData::Dict, ϵ = FTOtto.ϵ)  
    ...
    DATA["PROPS"] = Dict{String, Any}(
        "O2"    => (0.2598, 0.9180, 0.6580, 0.00, 0.00, 0.00      , 0.00 , 31.999,       0),
        ...
        "CO2"   => (0.1889, 0.8460, 0.6570, 0.00, 0.00, 0.00      , 0.00 , 44.01 , -393520),
        "H2O"   => (0.4615, 1.8723, 1.4108, 0.00, 0.00, 0.00      , 0.00 , 18.015, -241820),
    )
    #Dados para cp = cp(T)
